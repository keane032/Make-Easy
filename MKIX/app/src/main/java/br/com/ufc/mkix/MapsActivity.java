...
//                .getBestProvider(criteria, false));//        mMap.addMarker(new MarkerOptions().position(sydney).title("Marker in Sydney"));
        double latitude = -4.9713434;
        double longitude = -39.0170893;
